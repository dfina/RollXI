...
- B4 (DONE): Conference League + Intertoto. 77 tier-O rows in pack-opponents-confl-itc.json.
- C1 (DONE): Serie A 2024-25 — all 20 clubs pickable (19 built + Inter from Wave Fa). pack-pickable-c1.json.
- Next: C2 = Serie A 2023-24.
