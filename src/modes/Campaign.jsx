...
export default function Campaign({ data }) {
  ...
  if (camp.phase === "league") return <LeagueScreen data={data} camp={camp} onUpdate={persist} onReset={() => { save(SAVE_KEY, null); setCamp(null); }} />;
  return <DoneScreen camp={camp} onReset={() => { save(SAVE_KEY, null); setCamp(null); }} />;
}
...
/* ---------------- done: league finished ---------------- */
function DoneScreen({ camp, onReset }) {
  ...
  return (
    <div className="fade">
      ...
      <div className="card" style={{ padding: 18, marginTop: 10, textAlign: "center" }}>
        ...
        <p className="dim" style={{ fontSize: 12, margin: "10px 0 0" }}>Knockout rounds arrive in the next update (chunk A3).</p>
      </div>
